...
df_cols =  ['ms_played','master_metadata_track_name',"master_metadata_album_album_name","master_metadata_album_artist_name",'ts',"conn_country","episode_name",'episode_show_name','offline_timestamp','incognito_mode','ip_addr_decrypted','offline','platform','reason_end','reason_start','shuffle','skipped','spotify_episode_uri','spotify_track_uri','user_agent_decrypted','username']
